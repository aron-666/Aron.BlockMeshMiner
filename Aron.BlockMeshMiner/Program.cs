...
using Aron.BlockMeshMiner.Data;
using Aron.BlockMeshMiner.Jobs;
...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            if (Environment.GetEnvironmentVariables().Contains("BM_EMAIL"))
            {
                appConfig.UserName = Environment.GetEnvironmentVariable("BM_EMAIL").ToString();
            }

            if (Environment.GetEnvironmentVariables().Contains("BM_PASS"))
            {
                appConfig.Password = Environment.GetEnvironmentVariable("BM_PASS").ToString();
            }
